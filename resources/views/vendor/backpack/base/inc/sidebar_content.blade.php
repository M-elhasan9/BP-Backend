...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('map') }}'><i class='nav-icon la la-map-o'></i>Interactive Map</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('fires') }}'><i class='nav-icon la la-fire'></i>Existed Fires</a></li>
